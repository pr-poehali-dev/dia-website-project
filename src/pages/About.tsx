  ...
  const values = [
    {
      icon: 'BookOpen',
      title: 'Качество',
      description: 'Тщательный отбор рукописей и внимание к каждой детали'
    },
    {
      icon: 'Heart',
      title: 'Культура',
      description: 'Развитие литературы и поддержка талантливых авторов'
    },
    {
      icon: 'Sparkles',
      title: 'Инновации',
      description: 'Современные подходы к классическому издательскому делу'
    }
  ];
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none text-muted-foreground space-y-6 animate-fade-in">
              <p className="text-xl leading-relaxed">
                ...
                основанный в 2010 году с миссией сохранения и развития литературной культуры.
              </p>
              
              <p className="leading-relaxed">
                За годы работы мы выпустили более 500 книг различных жанров — от современной прозы 
                до философских трактатов. Наша философия основана на балансе между коммерческим 
                успехом и культурной ценностью каждого издания.
              </p>
              
              <p className="leading-relaxed">
                Мы работаем как с признанными мастерами слова, так и с начинающими авторами, 
                помогая им донести свои идеи до читателя в наилучшей форме.
              </p>
            </div>
          </div>
        </section>
